namespace BethanysPieShopAdmin.Models
{
    ...
    {
        public static void Seed(BPSDdContext context)
        {
        ...
        public static Dictionary<string, Category> Categories
        {
            get
            {
                if (categories == null)
                {
                    ...
                    {
                        new Category { CategoryName = "Fruit pies", DateAdded = DateTime.Today },
                        new Category { CategoryName = "Cheese cakes", DateAdded = DateTime.Today },
                        new Category { CategoryName = "Seasonal pies", DateAdded = DateTime.Today }
                    };
